...
export function Sidebar({ isMobile = false }: SidebarProps) {
  ...
  return (
    <div className={isMobile ? "flex w-64 flex-col" : "hidden lg:flex lg:w-64 lg:flex-col"}>
      <div className="flex h-full flex-col bg-card border-r border-border">
        ...
        <nav className="flex-1 px-3 py-4 space-y-2">
          {navigationGroups.map((group) => (
            ...
            >
              <CollapsibleTrigger className="flex items-center justify-between w-full px-3 py-2 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-accent rounded-md transition-colors duration-200">
